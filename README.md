...
```hcl
module "langfuse" {
  source = "github.com/langfuse/langfuse-terraform-azure?ref=0.4.2"
  ...
  langfuse_helm_chart_version = "1.5.4"
...
| langfuse_helm_chart_version       | Version of the Langfuse Helm chart to deploy  | string | "1.5.4"              |    no    |
