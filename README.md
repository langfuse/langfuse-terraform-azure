...
```hcl
module "langfuse" {
  source = "github.com/langfuse/langfuse-terraform-azure?ref=1.0.4"
...
| langfuse_helm_chart_version       | Version of the Langfuse Helm chart to deploy                                                                                                             | string | "2.1.1"                       |    no    |
| app_version                       | Langfuse application version (Docker image tag) to deploy. Defaults to the latest release at the time this module version was published.                 | string | "4.38.0"                      |    no    |
